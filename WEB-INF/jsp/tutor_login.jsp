            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body  p-3">
                  ...
                  <div class="pt-4">
                    <h5 class="card-title text-center pb-0 fs-4">Login to <b>Tutor</b> Account</h5>
                  </div>
	<div class="px-4">
     <html:form action="/loginPath">
	<table align="center" class="table table-borderless">
		<tr>
			<td colspan="2" align="right"><html:errors property="loginerror" /></td>
		</tr>
		<tr>
			<td><span class="card-title">Email:</span></td>
			<td><html:text property="frmTutorEmail"></html:text> </td>
		</tr>
		<tr>
			<td colspan="2" align="right"><html:errors property="frmTutorEmail"/></td>
		...
		<tr>
			<td colspan="2" align="right"><html:errors property="frmPassword"/></td>
		</tr>
		<tr>
		...
		<div class="row px-4 ">
			<div class="p-1">New user? Please <a href="registerPathFirst.do">Register</a>.</div>
