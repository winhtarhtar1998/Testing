			...
			<div class="card-body pt-3 fade show active profile-overview">
                 <h5 class="card-title">Class Information</h5> 
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">${MyTutorsFormBean.frmDetailTeach.subject.subjectName}</div>
                  </div>
                  
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Teaching Type</div>
                    <div class="col-lg-9 col-md-8">${MyTutorsFormBean.frmDetailTeach.teachingType}</div>
                  </div>
                                    
				  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Periods per Week</div>
                    <div class="col-lg-9 col-md-8">${MyTutorsFormBean.frmDetailTeach.periodPerWeek} periods</div>
                  </div>
                 
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Preferable Time & Days</div>
                    <div class="col-lg-9 col-md-8">${MyTutorsFormBean.frmDetailTeach.preferableTime} <br>
                    <div class="col-lg-9 col-md-8">${MyTutorsFormBean.frmDetailTeach.preferableDays}
                    </div>
  				</div>			
			</div>
			</div>
