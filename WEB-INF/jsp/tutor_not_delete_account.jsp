        ...
        <div class="col-xl-12">
          ...
          <div class="card ">
            ...
            <div class="card-body">
				...
				<h5 class="card-title text-danger">Cannot Delete Your Tutor Account</h5>	
                
                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <h4 class="alert-heading">You can't delete your account at this time!</h4>
                <p><i class="bi bi-exclamation-triangle me-1"></i>Your Tutor Account still had connected <span class="fw-bold">( ${DeleteFormBean.frmNumConnectedStudents} )</span> 
                	students at this time, and students still need your contact information.</p>
                <p><i class="bi bi-exclamation-triangle me-1"></i>You can delete your account only when you haven't connected with any student.</p>
              </div>
         	</div>				
	 		</div>
       		 </div>
