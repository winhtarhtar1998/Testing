...
<body>
 ...
 <section class="section profile">
        ...
        <div class="card-body pt-3 fade show active profile-overview">
  		<html:form action="/editSubjectPath">
  	<logic:empty property="frmRegFormControl" name="EditSubjectFormBean">
  			<h5 class="card-title">Edit Subject</h5> 
  			<div class="row">
                   <div class="col-lg-4 col-md-4 label">Subject</div>
                   <div class="col-lg-8 col-md-8"><html:text property="frmSubjectName" disabled="true"></html:text></div>
            ...
            <div class="row">
                    	...
                    	<span class=""><html:submit property="btnEditSubject" value="Save"></html:submit></span>
		...
		<logic:notEmpty property="frmRegFormControl" name="EditSubjectFormBean">
		<h5 class="card-title">Confirm Your Data</h5> 
            ...
            <div class="row">
			 ...
			 <div class="row">
                    	<div class="col-lg-12 col-md-12" >
                    	<span class=""><html:submit property="btnEditSubjectSave" value="Save"></html:submit></span>
