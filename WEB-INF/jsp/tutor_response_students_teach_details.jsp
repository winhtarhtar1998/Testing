			...
			<div class="card-body pt-3 fade show active profile-overview">
                 <h5 class="card-title">Class Information</h5> 
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">${ResponseStudentFormBean.frmRequestTeach.subject.subjectName}</div>
                  </div>
                  
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Teaching Type</div>
                    <div class="col-lg-9 col-md-8">${ResponseStudentFormBean.frmRequestTeach.teachingType}</div>
                  </div>
				  ...
				  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">${ResponseStudentFormBean.frmRequestTeach.periodPerWeek} periods</div>
                  </div>
                 
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Preferable Time & Days</div>
                    <div class="col-lg-9 col-md-8">${ResponseStudentFormBean.frmRequestTeach.preferableTime} <br>
                    <div class="col-lg-9 col-md-8">${ResponseStudentFormBean.frmRequestTeach.preferableDays}
                    </div>
  				</div>			
			</div>
			</div>
