 ...
 <%@ include file="inc/header_menu_student.jsp"%>
  ...
  <main id="main" class="main">
      ...
      <nav>
            ...
            <div class="card-header">
              <ul class="nav nav-pills card-header-pills align-items-center justify-content-center">
                ...
                <li class="nav-item">
                 ...
                 <li class="nav-item">
                  <a class="nav-link profile-tab active" href="StuChangePasswordPathFirst.do">Change Password</a>
                </li>
                <li class="nav-item">
            ...
            <div class="card-body">
            	<div class="row">
       			 <div class="col-xl-4">
            		 ...
            		 <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
             		 ...
             		 <img src="images/stu_${StuChangePasswordFormBean.frmStudentDetails.id}?time=<%=System.currentTimeMillis()%>" alt="No Photo" class="rounded-circle">
             		 <h2>${StuChangePasswordFormBean.frmStudentDetails.studentName}</h2>
             		 <h3 class="pt-2">${StuChangePasswordFormBean.frmStudentDetails.grade}</h3>
             		 <h4 class="small font-bold">${StuChangePasswordFormBean.frmStudentDetails.gender}</h4>
            		</div>
         			</div>
       		   ...
       		   <div class="col-xl-8">
					...
					<html:form action="/StuChangePasswordPath">
				<logic:empty property="frmRegFormControl" name="StuChangePasswordFormBean">
				...
				<h5 class="card-title">Change Password</h5>	
					...
					<div class="row">
                    	...
                    	<div class="col-lg-12"><html:errors property="frmRegPassword" /></div>
                  	</div>
                  	...
                  	<div class="row">
                    	...
                    	<div class="col-lg-12"><html:errors property="frmRegConfPassword" />
		...
		<logic:notEmpty property="frmRegFormControl" name="StuChangePasswordFormBean">
